...
/**
 * Create a method with an id of RandomTransitionGenerator and implements TransitionGenerator. This
 * method contains methods that determine the animation and duration
 */
public class RandomTransitionGenerator implements com.sfiscusdevelopment.sfiscus.booklit.splashScreen.TransitionGenerator {
    ...
    public Transition generateNextTransition(RectF drawableBounds, RectF viewport) {
        ...
        if (dstRect == null || drawableBoundsChanged || viewportRatioChanged) {
            ...
            // Sets the destiny rect of the last transition as the source one if the current drawable has
            // the same dimensions as the one with the last transition
            srcRect = dstRect;
        }
