...
import kotlinx.android.synthetic.main.book_not_found.*
...
import com.sfiscusdevelopment.sfiscus.booklit.customViews.BookTextWatcher
import com.sfiscusdevelopment.sfiscus.booklit.customViews.EndlessScrollListener
...
/**
 * Create a class with an id of SearchActivity. Kotlin programming language is used for this class
...
//        adapter = SearchAdapter(booksArray, this)
    ...
    override fun onAddToClickListener(bookWrapper: BookWrapper) {
        ...
        //applicationContext.toast("Book Id: " + selectedBook?.id)
    }
